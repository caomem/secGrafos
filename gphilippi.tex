...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.6\linewidth]{secGrafos/figures/koenigsbern.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.32\linewidth]{secGrafos/figures/koenigsbernGrafo.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.4\linewidth]{secGrafos/figures/grafocompleto.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.4\linewidth]{secGrafos/figures/cliques.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.26\linewidth]{secGrafos/figures/weightedGraph.png}
	\end{center}
